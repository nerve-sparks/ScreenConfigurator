...
function orderedJourney(screens, screenIds, startScreenId) {
...
export default function AgentFlow({
  ...
  return (
    <section className="agent-flow" aria-label={`${agentName} screens`}>
      <ol className="agent-flow-rail" aria-label="Agent screen progress">
        {journey.map((screen, index) => (
          ...
          >
            ...
            <div>
              ...
              <small>{screen.screen_type} · {screen.purpose}</small>
            </div>
          </li>
        ))}
      </ol>
