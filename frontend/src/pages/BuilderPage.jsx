...
import { isWizardManifest } from '../lib/manifestLayout.js'
import {
  REVIEW_STATUS,
...
import { savePreviewDraft } from '../lib/routeDraft.js'
...
const ManifestReview = lazy(() => import('../components/ManifestReview.jsx'))
const LayoutEditor = lazy(() => import('../components/LayoutEditor.jsx'))
...
export default function BuilderPage() {
  ...
  const projectReturnPath = projectMode
    ? `/studio/agents/${encodeURIComponent(projectAgentId)}?step=${encodeURIComponent(returnStep)}`
    : '/library'
      ...
      <div className="modern-editor-shell">
        <aside className="project-sidebar" aria-label="Project navigation">
          ...
          <div className="project-sidebar-footer">
            <Link to={projectMode ? projectReturnPath : '/library'}>
              ← {projectMode ? 'Back to approve' : 'Agent library'}
            </Link>
